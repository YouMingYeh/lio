  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div className="relative flex min-w-[300px] flex-wrap gap-1">
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="bg-popover text-popover-foreground fade-in animate-in absolute top-1 z-10 w-full rounded-md border shadow-md"
              onMouseLeave={() => {
